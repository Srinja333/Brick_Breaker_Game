...
/*KeyListener for detecting arrow keys for moving the slider and ActionListener for ball*/
public class Gameplay extends JPanel implements KeyListener,ActionListener {
	...
	
	{
		...
		if(ballposX==120 && ballposY==350)
		{
			g.setColor(Color.green);
			g.setFont(new Font("serif",Font.BOLD,32));
			g.drawString("press left arrow key to start",135,300);
		}
		if(totalBricks<=0) {
			play=false;
			ballXdir=0;
		...
		if(ballposY>570)
		{
			...
			g.drawString("press enter to restart",204,350);
